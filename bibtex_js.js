...
<head>
    ...
    <title>
        Manuela Velosos's Publications
    </title>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    <script src="bibtex_js_v2.js" type="text/javascript" charset="utf-8"></script>
    <bibtex src="veloso-mystery.bib"></bibtex>
...
<body>
<a name="top"></a>
<h1 class="header">Manuela Veloso's Publications  <br>
  <!--
  <small> <a href="http://www.cs.cmu.edu/~mmv/Veloso-AI-Finance.html">
      Additional publications on AI in Finance (after 2018) </a>  -->
  <small>  (Use the Search to browse interests.)
</h1>
<br>
